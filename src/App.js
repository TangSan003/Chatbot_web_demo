...
function App() {
    ...
    try {
      const response = await fetch("https://TangSan003-api-chatbot-travel-multi-turn-chat-gemini.hf.space/pred", {
        ...
        body: JSON.stringify({
          ...
          extract: " Dữ liệu không chứa thông tin về câu hỏi của con người nên không thể trích xuất dữ liệu theo yêu cầu."
        },)
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hộp chat */}
      {isChatOpen && (
        <div className="fixed bottom-24 right-6 w-80 h-[500px] bg-white border border-gray-300 rounded-lg shadow-xl flex flex-col">
